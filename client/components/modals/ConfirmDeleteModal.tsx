    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm transition-all">
      ...
      >
        ...
        <div className="flex flex-col items-center pt-8">
          <span className="flex items-center justify-center w-16 h-16 rounded-full bg-red-100 mb-2">
            <FaTrash className="text-red-500" size={32} />
          </span>
        </div>
        {/* Title */}
        ...
        <div className="px-8 pb-6 text-center">
          <p id="confirm-modal-desc" className="text-gray-700 mb-6 text-base">
            {description}
          </p>
          <div className="flex flex-col sm:flex-row-reverse gap-2 border-t border-gray-100 pt-4">
            ...
            <button
              type="button"
              onClick={onConfirm}
              className="w-full sm:w-auto px-4 py-2 rounded-lg bg-red-500 text-white font-semibold shadow hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 transition flex items-center justify-center gap-2"
              disabled={loading}
              tabIndex={0}
